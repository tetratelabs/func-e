...
func TestGetEnvoyExtensionTestValidateFlag(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.flag+"="+test.flagValue, func(t *testing.T) {
			...
			cmd.SetArgs([]string{"extension", "test", test.flag, test.flagValue})
...
func TestGetEnvoyExtensionTestFailsOutsideWorkspaceDirectory(t *testing.T) {
	...
	cmd, stdout, stderr := cmd2.NewRootCommand()
	cmd.SetArgs([]string{"extension", "test"})
	err := cmdutil.Execute(cmd)
...
func TestGetEnvoyExtensionTestFail(t *testing.T) {
	...
	// Run "getenvoy extension test"
	cmd, stdout, stderr := cmd2.NewRootCommand()
	cmd.SetArgs([]string{"extension", "test", "--toolchain-container-options", toolchainOptions})
	err := cmdutil.Execute(cmd)
