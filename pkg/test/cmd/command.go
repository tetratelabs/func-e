...
func ParseEnvoyWorkDirectory(t *testing.T, stdout string, msgAndArgs ...interface{}) string {
	re := regexp.MustCompile(`.*envoy pwd: (.*)\n.*`)
	require.Regexp(t, re, stdout, msgAndArgs...)
	return re.FindStringSubmatch(stdout)[1]
}
