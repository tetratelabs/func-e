...
// Envoy currently supports [aarch64/arm64, s390x, mips64, ppc, x86_64] as build targets.
// See the envoyproxy/envoy repository for more details.
// https://github.com/envoyproxy/envoy/blob/main/bazel/BUILD
type Build_Architecture int32

const (
	Build_UNKNOWN_ARCH Build_Architecture = 0
	Build_X86_64       Build_Architecture = 1
	Build_ARM64        Build_Architecture = 2
)

// Enum value maps for Build_Architecture.
var (
	Build_Architecture_name = map[int32]string{
		0: "UNKNOWN_ARCH",
		1: "X86_64",
		2: "ARM64",
	}
	Build_Architecture_value = map[string]int32{
		"UNKNOWN_ARCH": 0,
		"X86_64":       1,
		"ARM64":        2,
	}
...
func (x Build_Architecture) Enum() *Build_Architecture {
	p := new(Build_Architecture)
	*p = x
	return p
}

func (x Build_Architecture) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Build_Architecture) Descriptor() protoreflect.EnumDescriptor {
	return file_api_manifest_proto_enumTypes[2].Descriptor()
}

func (Build_Architecture) Type() protoreflect.EnumType {
	return &file_api_manifest_proto_enumTypes[2]
}

func (x Build_Architecture) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Build_Architecture.Descriptor instead.
func (Build_Architecture) EnumDescriptor() ([]byte, []int) {
	return file_api_manifest_proto_rawDescGZIP(), []int{3, 1}
}
...
type Build struct {
	...
	Architecture        Build_Architecture `protobuf:"varint,3,opt,name=architecture,proto3,enum=api.Build_Architecture" json:"architecture,omitempty"`
}
...
func (x *Build) GetArchitecture() Build_Architecture {
	if x != nil {
		return x.Architecture
	}
	return Build_UNKNOWN_ARCH
}
...
var file_api_manifest_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x64, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa5,
	0x02, 0x0a, 0x05, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x12, 0x2f, 0x0a, 0x08, 0x70, 0x6c, 0x61, 0x74,
	...
	,
...
var file_api_manifest_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_api_manifest_proto_goTypes = []interface{}{
	...
	(Build_Architecture)(0), // 2: api.Build.Architecture
	(*Manifest)(nil),        // 3: api.Manifest
	(*Flavor)(nil),          // 4: api.Flavor
	(*Version)(nil),         // 5: api.Version
	(*Build)(nil),           // 6: api.Build
	nil,                     // 7: api.Manifest.FlavorsEntry
	nil,                     // 8: api.Flavor.VersionsEntry
	nil,                     // 9: api.Version.BuildsEntry
}
var file_api_manifest_proto_depIdxs = []int32{
	7, // 0: api.Manifest.flavors:type_name -> api.Manifest.FlavorsEntry
	0, // 1: api.Flavor.compliances:type_name -> api.Compliance
	8, // 2: api.Flavor.versions:type_name -> api.Flavor.VersionsEntry
	9, // 3: api.Version.builds:type_name -> api.Version.BuildsEntry
	1, // 4: api.Build.platform:type_name -> api.Build.Platform
	2, // 5: api.Build.architecture:type_name -> api.Build.Architecture
	4, // 6: api.Manifest.FlavorsEntry.value:type_name -> api.Flavor
	5, // 7: api.Flavor.VersionsEntry.value:type_name -> api.Version
	6, // 8: api.Version.BuildsEntry.value:type_name -> api.Build
