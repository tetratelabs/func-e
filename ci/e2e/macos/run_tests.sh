...
export E2E_BUILTIN_TOOLCHAIN_CONTAINER_OPTIONS="${E2E_BUILTIN_TOOLCHAIN_CONTAINER_OPTIONS} -e HOME=/tmp/getenvoy -v $HOME/.ssh/id_rsa_e2e_github_machine_user:/tmp/getenvoy/.ssh/id_rsa"
