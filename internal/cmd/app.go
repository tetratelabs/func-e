...
such as glibc. This value must be constant within a ` + "`$FUNC_E_DATA_HOME`" + `.`
	...
	app.Before = func(c *cli.Context) error {
		...
		if homeDir != "" {
			_, _ = fmt.Fprintln(c.App.ErrWriter, "WARNING: $FUNC_E_HOME (--home-dir) is deprecated and will be removed in a future version.")
			_, _ = fmt.Fprintln(c.App.ErrWriter, "Please use --config-home, --data-home, --state-home or --runtime-dir instead.")
		}
